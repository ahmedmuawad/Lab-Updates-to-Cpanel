...
Route::group(['prefix'=>'ajax','as'=>'ajax.','middleware'=>'Ajax'],function(){
    ...
    //get normal_doctors
    Route::get('get_normal_doctors','AjaxController@get_normal_doctors')->name('get_normal_doctors')->middleware('Admin');

    //create doctor
    Route::post('create_doctor','AjaxController@create_doctor')->name('create_doctor')->middleware('Admin');
    
    //create doctor
    Route::post('create_normal_doctor','AjaxController@create_normal_doctor')->name('create_normal_doctor')->middleware('Admin');
    ...
    //get representative
    Route::get('get_reps','AjaxController@get_reps')->name('get_reps')->middleware('Admin');
    
    //get labs
    Route::get('get_labs','AjaxController@get_labs')->name('get_labs')->middleware('Admin');
    ...
    //get invoice tests
    Route::get('get_invoice_rays','AjaxController@get_invoice_rays')->name('get_invoice_rays')->middleware('Admin');
    
    //get invoice ray
    Route::get('get_invoice_ray','AjaxController@get_invoice_ray')->name('get_invoice_tests')->middleware('Admin');
    ...
    //get employee
    Route::get('get_employees','AjaxController@get_employees')->name('get_employees')->middleware('Admin');
    Route::get('get_user_info','AjaxController@get_user_info')->name('get_user_info')->middleware('Admin');
    
    // get get_rays_categories
    Route::get('get_rays_categories','AjaxController@get_rays_categories')->name('get_rays_categories')->middleware('Admin');
