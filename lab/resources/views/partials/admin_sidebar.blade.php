@php
    $branch_rays = App\Models\Branch::find(session('branch_id'))->ray_status;
@endphp
        ...
        @can('view_group')
            <li class="nav-item has-treeview" id="groups">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.groups.create') }}" class="nav-link" id="create_group">
                            <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/calce') }}" class="nav-link" id="create_group">
                            <i class="far fa-circle nav-icon"></i>
                            <p>{{ __('Calculator') }}</p>
                        </a>
                    </li>
