                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody id="selected_rays">
                            @if(isset($group) && $group['rays'] )
                                ...
                                <tr class="selected_ray" id="ray_{{$ray['ray_id']}}" default_price="{{$ray['ray']['price']}}">
                                    <td>
                                    {{$ray['ray']['name']}}
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody id="selected_tests">
                            @if(isset($group))
                                ...
                                <tr class="selected_test" id="test_{{$test['test_id']}}" default_price="{{$test['test']['price']}}">
                                    <td>
                                    {{$test['test']['name']}}
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody id="selected_cultures">
                            @if(isset($group))
                                ...
                                <tr class="selected_culture" id="culture_{{$culture['culture_id']}}" default_price="{{$culture['culture']['price']}}">
                                    <td>
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody id="selected_packages">
                            @if(isset($group))
                                ...
                                <tr class="selected_package" id="package_{{$package['package_id']}}" default_price="{{$package['package']['price']}}">
                                    <td>
