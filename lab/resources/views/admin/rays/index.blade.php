      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{__('Rays')}}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">{{__('Rays Table')}}</h3>
      @can('create_test')
      <a href="{{route('admin.rays.create')}}" class="btn btn-primary btn-sm float-right">
    ...
    <div class="card-body">
      ...
      <div class="row">
       <div class="col-lg-12 table-responsive">
        <table id="rays_table" class="table table-striped table-bordered"  width="100%">
          <thead>
            <tr>
              <th width="10px">
