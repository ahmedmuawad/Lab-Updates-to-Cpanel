        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="nav flex-column nav-tabs  h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link"  data-toggle="pill" href="#medical_settings" role="tab" aria-controls="medical_settings" aria-selected="true"><i class="fas fa-barcode"></i> {{__('medical')}}</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
              <div class="tab-content" id="vert-tabs-tabContent">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                  <div class="col-lg-2">
                                    ...
                                    <input type="number" min="50"  id="qrcode-dimension" name="qrcode-dimension" class="form-control" value="{{$reports_settings['qrcode-dimension']}}"  required>
                                  </div>
                                </div>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                  ...
                                                  <select class="form-control" name="report_header[text-align]" id="report_header_text_align" required>
                                                    <option value="center" @if($reports_settings['report_header']['text-align']=='center') selected @endif>{{__('Center')}}</option>
                                                    <option value="left" @if($reports_settings['report_header']['text-align']=='left') selected @endif>{{__('Left')}}</option>
                                                    <option value="right" @if($reports_settings['report_header']['text-align']=='right') selected @endif>{{__('Right')}}</option>
                                                  </select>
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="report_header_border_color" type="text" class="form-control color_input" name="report_header[border-color]" value="{{$reports_settings['report_header']['border-color']}}" required>
                                                        <div class="input-group-append color_tool">
                                                            <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['report_header']['border-color']}}"></i></span>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                  ...
                                                  <input type="number" class="form-control" name="report_header[border-width]" id="report_header_border_width" min="1" value="{{$reports_settings['report_header']['border-width']}}" required>
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="report_header_background_color" type="text" class="form-control color_input" name="report_header[background-color]" value="{{$reports_settings['report_header']['background-color']}}" required>
                                                        <div class="input-group-append color_tool">
                                                            <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['report_header']['background-color']}}"></i></span>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-lg-3">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          <input id="report_footer_border_color" type="text" class="form-control color_input" name="report_footer[border-color]" value="{{$reports_settings['report_footer']['border-color']}}" required>
                                                          <div class="input-group-append color_tool">
                                                              <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['report_footer']['border-color']}}"></i></span>
                                                          </div>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                    ...
                                                    <input type="number" class="form-control" name="report_footer[border-width]" id="report_footer_border_width" min="1" value="{{$reports_settings['report_footer']['border-width']}}" required>
                                                  </div>
                                                  ...
                                                  <div class="col-lg-3">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          <input id="report_footer_background_color" type="text" class="form-control color_input" name="report_footer[background-color]" value="{{$reports_settings['report_footer']['background-color']}}" required>
                                                          <div class="input-group-append color_tool">
                                                              <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['report_footer']['background-color']}}"></i></span>
                                                          </div>
                                                      </div>
                                                    </div>
                                                  </div>
                ...
                <!-- medical Settings -->
                <div class="tab-pane text-left fade show" id="medical_settings" role="tabpanel" aria-labelledby="medical_settings">
                      <div class="card card-primary">
                          <div class="card-header">
                              <h5 class="card-title">{{__('medical')}}</h5>
                          </div>
                          <form action="{{route('admin.settings.medical_submit')}}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                  <div class="col-lg-12">
                                    <div class="form-group">
                                      <label for="barcode_settings_type">{{__('Report Notice')}}</label>
                                      <input type="number" name="report_notice" id="report_notice" class="form-control" value="{{$medical_settings['report_notice']}}" required>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number" name="pt_control_time" id="pt_control_time" class="form-control" value="{{$medical_settings['pt_control_time']}}" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label for="isi">{{__('ISI')}}</label>
                                      <input type="number" name="isi" id="isi" class="form-control" value="{{$medical_settings['isi']}}" required>
                                    </div>
                                  </div>
                                </div>
