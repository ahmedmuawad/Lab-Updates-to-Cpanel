...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group @if($errors->has('lab_code')) error-validation @endif">
            <label for="code">{{__('Code')}}</label>
            <input type="number" class="form-control" name="lab_code" placeholder="{{__('Code')}}" id="code" value="{{time()}}"
                @if(isset($lab)) value="{{$lab->lab_code}}" @endif required>
        </div>
    </div>
</div>
